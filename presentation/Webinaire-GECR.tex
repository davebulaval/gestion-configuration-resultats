...
\begin{document}
	...
	\begin{frame}{Gestion des paramètres de configuration}
		\begin{Scode} %% Camille : Correction du "line numbering"
	...
	\begin{frame}{Gestion des paramètres de configuration} %% Camille : retrait des mots inutiles
		\centering
		...
		\uncover<4->{\begin{minipage}{0.24\linewidth}
				...
				%doit-on se retrouver dans le projet? 
				%% Camille : Je ne suis pas certain de celui-ci, si c'Est vraiment ce que tu voulais dire ... 
		\end{minipage}}
	\end{frame}
	...
	\begin{frame}{Gestion des résultats} %% Camille : tentative de raccourcir pour éviter la lecture
		\centering
		\uncover<1->{\begin{minipage}{0.24\linewidth}
				\centering
				\normalsize Quelle configuration (déjà) utilisée ? % Quelle configuration déjà avec ces résultats?
		\end{minipage}}
		\uncover<2->{\begin{minipage}{0.24\linewidth}
				\centering
				\normalsize Succès ou échec ? % Est-ce un succès ou un échec cet entrainement?
		\end{minipage}}
		\uncover<3->{\begin{minipage}{0.24\linewidth}
				\centering
				\normalsize Lequel est le meilleur ? % Lequel contient mes meilleurs résultats?
		\end{minipage}}
		\uncover<4->{\begin{minipage}{0.24\linewidth}
				\centering
				\normalsize Comment les organiser ?  % Comment doit-on se retrouver dans les résultats?
		\end{minipage}}
	\end{frame}
	...
	\begin{frame}{Intégration avec \link{https://poutyne.org/}{Poutyne}}
		La version de \guillemet{base} implique de journaliser manuellement % Camille : Factorisation du texte :P 
		\begin{itemize}
	...
	\begin{frame}{Intégration avec \link{https://poutyne.org/}{Poutyne}} % Camille : Factorisation du texte again
