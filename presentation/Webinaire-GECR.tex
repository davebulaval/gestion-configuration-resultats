...
%%% partie du projet «Gestion de l'entrainement, de la configuration et des résultats avec MLflow, Hydra et Poutyne
%%% - Webinaire»
%%% URL
%%%
...
%% =============================
\title{Gestion de l'entrainement, de la configuration et des résultats avec MLflow, Hydra et Poutyne}
...
\hypersetup{%
	...
	pdftitle = {Gestion de l'entrainement, de la configuration et des résultats avec MLflow, Hydra et Poutyne},
	colorlinks = {true},
	linktocpage = {true},
	allcolors = {link},
	urlcolor = {url},
...
\begin{document}
	...
	\begin{frame}{Objectifs de la présentation}
		\begin{itemize}
			...
			\item Développer des bonnes pratiques.
